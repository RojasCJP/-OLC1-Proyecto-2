...
class Else {
    constructor(instructionList, line, column) {
        this.condition = new expression_1.Expression(expression_1.Expression_type.BOOLEAN, 0, 0, null, null, 'true');
    ...
    execute(env) {
        ...
        if (conditionValue.type == sym_1.EnumType.boolean && conditionValue.value) {
